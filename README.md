...
- **R & RStudio (Modul 9):** R und RStudio Desktop installieren, die vier Bereiche der Oberfläche kennenlernen, Skripte als `.R`-Dateien speichern und ausführen, Daten mit View() ansehen, Arbeitsverzeichnis und Dateipfade festlegen sowie Pakete verwenden.
